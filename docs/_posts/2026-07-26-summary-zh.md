...
## 一手资讯速递
1. [Cloudflare 新增 AI 爬虫控制](#item-1) ⭐️ 8.0/10
2. [ChatGPT 有害生物安全回复引发警报。](#item-2) ⭐️ 8.0/10
3. [Monday.com 加入 AI 裁员潮](#item-3) ⭐️ 7.85/10
4. [AI 与就业：炒作与现实](#item-4) ⭐️ 7.62/10
5. [AI 编码工具正在推动考试改革。](#item-5) ⭐️ 7.6/10
6. [图书馆举办热门“避开 AI”工作坊](#item-6) ⭐️ 7.55/10
7. [GrapheneOS 解释锁定设备取证防护。](#item-7) ⭐️ 7.4/10
8. [DeepSeek 因算力担忧暂停融资](#item-8) ⭐️ 7.2/10
9. [Debian 讨论 LLM 辅助贡献政策](#item-9) ⭐️ 7.2/10
10. [美国考虑定向限制中国开放权重 AI](#item-10) ⭐️ 7.2/10
11. [MonkeyOCRv2 将多语种文档解析缩到 0.7B](#item-11) ⭐️ 7.0/10

## 实战与专家洞察
12. [Anthropic 为 Claude 5 模型重塑上下文工程规则。](#item-12) ⭐️ 9.0/10
13. [Ruff v0.16.0 扩大默认检查](#item-13) ⭐️ 8.0/10
14. [小型 LLM 在 8 美元 ESP32 上运行。](#item-14) ⭐️ 8.0/10
15. [Inflect-Micro-v2 让微型本地语音合成更实用。](#item-15) ⭐️ 7.2/10
16. [交互式 Git Rebase 没那么可怕](#item-16) ⭐️ 7.0/10
...
<a id="item-1"></a>
### [Cloudflare 新增 AI 爬虫控制](https://blog.cloudflare.com/content-independence-day-ai-options/) ⭐️ 8.0/10
...
<a id="item-2"></a>
### [ChatGPT 有害生物安全回复引发警报。](https://the-decoder.com/hundreds-asked-chatgpt-for-poison-and-bioweapon-recipes-and-some-got-step-by-step-high-school-level-guides/) ⭐️ 8.0/10
...
<a id="item-3"></a>
### [Monday.com 加入 AI 裁员潮](https://techcrunch.com/2026/07/25/the-running-list-major-tech-layoffs-in-2026-where-employers-cited-ai/) ⭐️ 7.85/10
...
<a id="item-4"></a>
### [AI 与就业：炒作与现实](https://siepr.stanford.edu/publications/policy-brief/what-really-happening-jobs-separating-ai-hype-reality) ⭐️ 7.62/10
...
<a id="item-5"></a>
### [AI 编码工具正在推动考试改革。](https://the-decoder.com/the-ai-coding-tutor-paradox-grows-as-educators-scramble-to-rethink-how-they-test-real-skills/) ⭐️ 7.6/10
...
<a id="item-6"></a>
### [图书馆举办热门“避开 AI”工作坊](https://techcrunch.com/2026/07/25/librarians-are-hosting-viral-avoiding-ai-workshops-for-people-who-are-fed-up-with-big-tech/) ⭐️ 7.55/10
...
<a id="item-7"></a>
### [GrapheneOS 解释锁定设备取证防护。](https://discuss.grapheneos.org/d/40700-grapheneos-protections-against-data-extraction-from-locked-devices) ⭐️ 7.4/10
...
<a id="item-8"></a>
### [DeepSeek 因算力担忧暂停融资](https://github.com/demo-zexuan/liang-wenfeng-investor-meeting-2026-7-22/blob/master/%E6%A2%81%E6%96%87%E9%94%8B%E6%8A%95%E8%B5%84%E8%80%85%E4%BA%A4%E6%B5%81%E4%BC%9A-%E6%96%87%E5%AD%97%E7%A8%BF_1_18_translate_20260723201651.pdf) ⭐️ 7.2/10
...
<a id="item-9"></a>
### [Debian 讨论 LLM 辅助贡献政策](https://www.debian.org/vote/2026/vote_002) ⭐️ 7.2/10
...
<a id="item-10"></a>
### [美国考虑定向限制中国开放权重 AI](https://the-decoder.com/us-reportedly-favors-selective-bans-over-blanket-restrictions-on-chinese-open-weight-models-citing-security-concerns/) ⭐️ 7.2/10
...
<a id="item-11"></a>
### [MonkeyOCRv2 将多语种文档解析缩到 0.7B](https://mp.weixin.qq.com/s?__biz=MzIzNjc1NzUzMw==&mid=2247907283&idx=2&sn=5df8a52712c79f67232ca9672d4cc34e) ⭐️ 7.0/10
...
<a id="item-12"></a>
### [Anthropic 为 Claude 5 模型重塑上下文工程规则。](https://claude.com/blog/the-new-rules-of-context-engineering-for-claude-5-generation-models) ⭐️ 9.0/10
...
<a id="item-13"></a>
### [Ruff v0.16.0 扩大默认检查](https://astral.sh/blog/ruff-v0.16.0) ⭐️ 8.0/10
...
<a id="item-14"></a>
### [小型 LLM 在 8 美元 ESP32 上运行。](https://github.com/slvDev/esp32-ai) ⭐️ 8.0/10
...
<a id="item-15"></a>
### [Inflect-Micro-v2 让微型本地语音合成更实用。](https://huggingface.co/owensong/Inflect-Micro-v2) ⭐️ 7.2/10
...
<a id="item-16"></a>
### [交互式 Git Rebase 没那么可怕](https://cachebag.sh/journal/interactive-rebasing/) ⭐️ 7.0/10

这篇文章强调，`git rebase -i` 更像是一个实用的整理工具，而不是一种危险的仪式。文章指出，只要开发者理解 `--abort`、`reflog` 和提交恢复，就可以更安心地在合并前重写堆叠提交。 交互式变基是 Git 中保持历史清晰的重要技能，尤其适合使用 squash merge 或堆叠分支的团队。把它讲得更安全，可以降低使用门槛，让提交历史更整洁，评审流程也更规范。 关键的安全网在于，变基过程中如果出错通常可以中止，而且只要对象还没有被垃圾回收，已经提交的内容往往可以通过 `git reflog` 找回。文章和讨论还指出，变基时的冲突往往比较晦涩，因此理解每一步重写后的历史非常重要。
