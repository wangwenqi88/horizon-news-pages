...
## 一手资讯速递
1. [阿里巴巴预告 Qwen 3.8](#item-1) ⭐️ 8.0/10
2. [批评采纳比审查精度更重要](#item-2) ⭐️ 8.0/10
3. [NVIDIA NeMo Automodel 扩展 Diffusers 微调。](#item-3) ⭐️ 8.0/10
4. [Claude Code 搭载 Rust 版 Bun 预览版。](#item-4) ⭐️ 7.4/10
5. [Claude Code v2.1.214 修复权限绕过问题。](#item-5) ⭐️ 7.0/10
6. [Ollama 重申开放模型使命](#item-6) ⭐️ 7.0/10
7. [GraphDx 面向成本感知的序贯诊断。](#item-7) ⭐️ 7.0/10
8. [Cura 1T 面向医疗智能体 AI。](#item-8) ⭐️ 7.0/10
9. [AnovaX 带来本地优先的语音自动化。](#item-9) ⭐️ 7.0/10
10. [ARC-AGI-3 智能体消融研究](#item-10) ⭐️ 7.0/10
11. [SQLite 查询解释器在浏览器中运行。](#item-11) ⭐️ 7.0/10
12. [DrawingVQA 评测施工图纸多模态推理](#item-12) ⭐️ 6.5/10
13. [Claude Fable 5 保留在订阅中](#item-13) ⭐️ 6.5/10
14. [AI 建议可能降低准确率。](#item-14) ⭐️ 6.0/10
15. [Databricks 估值据称达到 1880 亿美元](#item-15) ⭐️ 6.0/10

## 实战与专家洞察
16. [ESP32 改造替代保龄球计分系统](#item-16) ⭐️ 8.0/10
17. [JamCorder 带来的小规模硬件经验。](#item-17) ⭐️ 8.0/10
18. [MikroTik 可用作家庭路由器。](#item-18) ⭐️ 7.0/10
19. [自定义深度研究流水线的令牌成本经验](#item-19) ⭐️ 7.0/10
20. [OpenAI 提出 AI 投资回报评分卡](#item-20) ⭐️ 7.0/10
...
<a id="item-1"></a>
### [阿里巴巴预告 Qwen 3.8](https://twitter.com/Alibaba_Qwen/status/2078759124914098291) ⭐️ 8.0/10
...
<a id="item-2"></a>
### [批评采纳比审查精度更重要](https://arxiv.org/abs/2607.15388) ⭐️ 8.0/10
...
<a id="item-3"></a>
### [NVIDIA NeMo Automodel 扩展 Diffusers 微调。](https://huggingface.co/blog/nvidia/scale-diffusers-finetuning-nemo-automodel) ⭐️ 8.0/10
...
<a id="item-4"></a>
### [Claude Code 搭载 Rust 版 Bun 预览版。](https://simonwillison.net/2026/Jul/19/claude-code-in-bun-in-rust/#atom-everything) ⭐️ 7.4/10
...
<a id="item-5"></a>
### [Claude Code v2.1.214 修复权限绕过问题。](https://github.com/anthropics/claude-code/releases/tag/v2.1.214) ⭐️ 7.0/10

Anthropic 发布了 Claude Code v2.1.214，修复了多项与权限检查、命令自动批准、远程确认提示以及 Windows PowerShell 行为相关的安全问题。该版本还加入了 EndConversation 工具、OpenTelemetry 关联字段、可配置的遥测内容长度限制，以及长时间运行工具调用的进度心跳。 Claude Code 可以在开发者机器上运行 shell 命令并编辑文件，因此权限分析中的错误可能把便利功能变成非预期写入或命令执行路径。对于在代码仓库、远程会话、Windows 环境中使用 AI 编码代理，或依赖自动批准规则的团队来说，这些修复尤其重要。 该版本修复了单段允许规则问题，例如 `Edit(src/**)` 这类模式曾可能批准写入预期当前工作目录范围之外的嵌套 `src/` 目录。它还把多个 shell 分析场景改为保守失败，包括 PowerShell 5.1 绕过、Bash 文件描述符重定向解析不一致、超过 10000 个字符的命令、`[[ ]]` 中的 zsh 下标或修饰符处理，以及某些 `help`、`man` 和 Docker 或 Podman 远程守护进程选项。
...
<a id="item-6"></a>
### [Ollama 重申开放模型使命](https://ollama.com/blog/all-aboard-open-models) ⭐️ 7.0/10
...
<a id="item-7"></a>
### [GraphDx 面向成本感知的序贯诊断。](https://arxiv.org/abs/2607.15280) ⭐️ 7.0/10
...
<a id="item-8"></a>
### [Cura 1T 面向医疗智能体 AI。](https://arxiv.org/abs/2607.15314) ⭐️ 7.0/10
...
<a id="item-9"></a>
### [AnovaX 带来本地优先的语音自动化。](https://arxiv.org/abs/2607.15367) ⭐️ 7.0/10
...
<a id="item-10"></a>
### [ARC-AGI-3 智能体消融研究](https://arxiv.org/abs/2607.15439) ⭐️ 7.0/10
...
<a id="item-11"></a>
### [SQLite 查询解释器在浏览器中运行。](https://simonwillison.net/2026/Jul/18/sqlite-query-explainer/#atom-everything) ⭐️ 7.0/10
...
<a id="item-12"></a>
### [DrawingVQA 评测施工图纸多模态推理](https://arxiv.org/abs/2607.15418) ⭐️ 6.5/10
...
<a id="item-13"></a>
### [Claude Fable 5 保留在订阅中](https://simonwillison.net/2026/Jul/18/claude-make-fable-5-permanent/#atom-everything) ⭐️ 6.5/10
...
<a id="item-14"></a>
### [AI 建议可能降低准确率。](https://thenextweb.com/news/ai-advice-suppresses-critical-thinking-wrong-answers-study) ⭐️ 6.0/10
...
<a id="item-15"></a>
### [Databricks 估值据称达到 1880 亿美元](https://techcrunch.com/2026/07/17/databricks-hits-188b-valuation-extending-its-run-as-ais-favorite-second-act/) ⭐️ 6.0/10
...
<a id="item-16"></a>
### [ESP32 改造替代保龄球计分系统](https://news.ycombinator.com/item?id=48968606) ⭐️ 8.0/10
...
<a id="item-17"></a>
### [JamCorder 带来的小规模硬件经验。](https://chipweinberger.com/articles/20260719-hardware-is-not-so-hard) ⭐️ 8.0/10
...
<a id="item-18"></a>
### [MikroTik 可用作家庭路由器。](https://justsomebody.dev/blog/mikrotik-home-router) ⭐️ 7.0/10
...
<a id="item-19"></a>
### [自定义深度研究流水线的令牌成本经验](https://quesma.com/blog/custom-deep-research-pipeline/) ⭐️ 7.0/10
...
<a id="item-20"></a>
### [OpenAI 提出 AI 投资回报评分卡](https://openai.com/index/a-scorecard-for-the-ai-age) ⭐️ 7.0/10
